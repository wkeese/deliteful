define([
	...
	function checkAriaProperties(openPanels, closedPanels) {
		openPanels.forEach(function (panel) {
			var button = panel.headerNode.querySelector("[aria-controls]");
			assert.strictEqual(panel.headerNode.getAttribute("role"), "heading", "open heading role");
		...
		closedPanels.forEach(function (panel) {
			var button = panel.headerNode.querySelector("[aria-controls]");
			assert.strictEqual(panel.headerNode.getAttribute("role"), "heading", "closed heading role");
